...
```
Total ad / tracking block list 屏蔽追踪广告总数: 107080

Total allowlist list 允许名单总数: 1495

Total combine list 结合总数： 106951
