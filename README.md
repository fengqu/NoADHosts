...
```
Total ad / tracking block list 屏蔽追踪广告总数: 110765

Total allowlist list 允许名单总数: 1554

Total combine list 结合总数： 110621

Total deadblock list 失效屏蔽广告域名： 17687

Total deadallow list 失效允许广告域名： 99

Update 更新时间: 2020-10-29
```
### UPTODATE 保持最新<br/>
